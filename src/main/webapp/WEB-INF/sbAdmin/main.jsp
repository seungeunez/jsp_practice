...
<meta name="description" content="웹 솔루션 관리자화면으로 가장 많이 사용되는 웹 템플릿입니다">
...
<!--탭 아이콘 변경-->
<link rel="icon" href="${pageContext.request.contextPath}/resources/images/admin/ui.ico">
...
<body class="sb-nav-fixed">
	...
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		<!--Navbar Brand-->
		<a class="navbar-brand ps-3" href="./adminindex.html"> <!-- <i class="bi bi-tools"></i> -->
		...
		<form
			...
			<div class="input-group">
				<!--input group 쓰면 태그 내에 있는 것들이 합쳐짐-->
		...
		<ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
			<li class="nav-item dropdown"><a
				class="nav-link dropdown-toggle" id="profile" href="#" role="button"
				data-bs-toggle="dropdown" aria-expanded="false"> <!--dropdown-toggle이게 클래스에 있어서 아이콘으로 역삼각형 모양이 뜸-->
					...
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="navigation.html">정적 내비게이션</a> <a
									class="nav-link" href="">라이트테마</a>
							</nav>
						</div>
						<!--페이지-->
						<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
						...
						<div class="collapse" id="collapsePages"
							...
							<nav class="sb-sidenav-menu-nested nav"
								...
								<!--계정-->
								<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
									data-bs-target="#pageCollapseAuth" aria-expanded="false"
									aria-controls="pageCollapseAuth"> 계정
									<div class="sb-sidenav-collapse-arrow">
										<i class="fas fa-angle-down"></i>
									</div>
								</a>
								<div class="collapse" id="pageCollapseAuth"
									aria-labelledby="headingThree"
									data-bs-parent="#sidenavAccordionPages">
									<nav class="sb-sidenav-menu-nested nav">
										<a class="nav-link" href="">로그인</a> <a class="nav-link"
											href="">회원등록</a> <a class="nav-link" href="">비밀번호 초기화</a>
									</nav>
								</div>
								<!--에러-->
								<a class="nav-link" href="#" data-bs-toggle="collapse"
									data-bs-target="#pageCollapseError" aria-expanded="false"
									aria-controls="pageCollapseError"> 에러
									<div class="sb-sidenav-collapse-arrow">
										<i class="fas fa-angle-down"></i>
									</div>
								</a>
								<div class="collapse" id="pageCollapseError"
									aria-labelledby="headingThree"
									data-bs-parent="#sidenavAccordionPages">
									<nav class="sb-sidenav-menu-nested nav">
										<a class="nav-link" href="./error401.html">401 페이지</a> <a
											class="nav-link" href="./error404.html">404 페이지</a> <a
											class="nav-link" href="./error500.html">500 페이지</a>
									</nav>
								</div>
							</nav>
						</div>
						...
						</a> <a class="nav-link" href="table.html">
							<div class="sb-nav-link-icon">
				...
				<div class="container-fluid px-4">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="card mb-4">
								<div class="card-header">
									<ic class="fas fa-chart-area me-1"></ic>
									라인차트 예제
								</div>
								<div class="card-body">
						...
						<div class="col-lg-6">
							<div class="card mb-4">
								<div class="card-header">
									<i class="fas fa-chart-bar me-1"></i> 바차트 예제
								</div>
								<div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <ic class="fas fa-chart-pie me-1"></ic>
                                    파이차트 예제
                                </div>
                                <div class="card-body">
					...
					<div class="row">
						<div class="col">
							<div class="card mb-4">
								<div class="card-header">
									<i class="fas fa-table me-1"></i> 테이블예제
								</div>
								<div class="card-body">
